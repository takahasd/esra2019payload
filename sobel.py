...
print("Target center is R" + center_red + " G" + center_green + " B" + center_blue + ".");
print("Average variance is " + variance_avg + ".");
print("Maximum variance is " + variance_max + ".");
print("Establishing position grid...");
g = 0;
